# college
Reflection of all the projects I've worked on during my three years @ NU. ***Bold + Italics*** are my favorite projects.

## Freshman Year

| Project  | Description |  Languages / Systems | Public Repo | External Links |
| --| --|--|:--:|:--:|
|***[WikiRaces 3](https://github.com/atfinke/WikiRaces)***|A multiplayer game in which up to eight players race to find Wikipedia articles as fast as possible.|Swift / iOS|✅|[App Store](https://itunes.apple.com/us/app/wikiraces-3/id1030997904?ls=1&mt=8)|
...
|***[Metra Live Map](https://github.com/atfinke/Metra/)***|Real time Metra train locations.|Swift / iOS / tvOS|✅|Discontinued|
|[Wildcat Wash](https://github.com/atfinke/Wildcat-Wash)|See the status of laundry rooms across the Northwestern University campus.|Swift / iOS|✅|Discontinued|
...
|***[Lake](https://github.com/atfinke/Lake)***| A high-fidelity low-cost rapid prototyping system. |Swift / iOS / watchOS|❌|[ACM DL](https://dl.acm.org/doi/10.1145/3290607.3308455)|
|[Lake Server](https://github.com/atfinke/Lake-Server)|Server for Lake.|Node.js / Heroku|✅|[Heroku](https://lake-server.herokuapp.com)|
...
|***[Creating With Code](https://github.com/atfinke/Autocomplete)***|Slides + Code for CWC Club I started to teach creating art with code.|Swift / iOS / Keynote|❌||
...
|[Language Checker](https://github.com/atfinke/LanguageChecker)| Checks webpages for grammar issues. |Python|❌||
...
|[WikiRaces Stats 2018](https://github.com/atfinke/WikiRaces-Stats-2018)|A few stats from my Wikipedia racing game, WikiRaces.|Markdown|❌|[Link](https://atfinke.github.io/WikiRaces-Stats-2018/)|
...
| Project  | Description |  Languages / Systems | Public Repo | External Link |
| --| --|--|:--:|:--:|
|***[A.Theatre](https://github.com/atfinke/website/)***|Site for seeing showtimes for our dorm suite theatre.|Python / Google App Engine / JS|❌|[Link](http://andrewfinke.com/theatre)|
