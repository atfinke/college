...
| Project  | Description |  Languages / Systems | Public | External Links |
| ------------- | ------------- |------------- |------------- |------------- |
...
|[Creating With Code](https://github.com/atfinke/Autocomplete)|Slides + Code for CWC Club I started.|Swift / iOS / Keynote|❌||
...
| Project  | Description |  Languages / Systems | Public | External Link |
| ------------- | ------------- |------------- |------------- |------------- |
|[A.Theatre](https://github.com/atfinke/website/)|Site for seeing showtimes for our dorm suite theatre.|Python / Google App Engine / JS|❌|[Link](http://andrewfinke.com/a.threate)|
